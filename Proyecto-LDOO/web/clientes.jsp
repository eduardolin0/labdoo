      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <div align="center">
            ...
            <form action="clientes_enviar.jsp" METHOD="post">
                Cliente:<br><input type="text" name="txtCliente"><br>
                Telefono:<br><input type="number" name="txtTelefono"><br>
                Direccion:<br><input type="text" name="txtDireccion"><br>
             ...
             <table class="table table-bordered"  id="tablaDatos">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Nombre del ciente:</th>
