    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <div align="center">
            <form action="datos_enviado.jsp" METHOD="post">
              Nombre:<br><input type="text" name="nombre"><br>
              Carrera:<br><select name="carrera">
                <option value="lsti">Seguridad en Tecnologías de Información</option>
                <option value="lcc">Ciencias Computacionales</option>
                <option value="matematico">Matemáticas</option>
                <option value="fisica">Física</option>
                <option value="actuaria">Actuaria</option>
              </select>
              <br>
              Fecha de nacimiento:<br><input type="date" name="fechanacimiento"><br>
              Contraseñaa: <br><input type="password" name="passw"><br>
