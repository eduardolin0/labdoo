...
<html lang="en">
  ...
  <head>
    ...
    <title>Práctica 5 - Lab de Diseño Orientado a Objetos</title>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <div align="center">
                   <form action="ver.htm" METHOD="post">
		              ...
		              Carrera:<br><select name="txtCarrera">
		                <option value="Seguridad en TI">Seguridad en Tecnologías de Información</option>
		                <option value="Ciencias Computacionales">Ciencias Computacionales</option>
		                <option value="Matemáticas">Matemáticas</option>
		                <option value="Actuaria">Actuaria</option>
		              </select>
		              <br>
		              Fecha de nacimiento:<br><input type="date" name="txtFechanac"><br>
		              Contraseña: <br><input type="password" name="txtContra"><br>
		              Correo electrónico:<br><input type="email" name="txtCorreoe"><br><br>
